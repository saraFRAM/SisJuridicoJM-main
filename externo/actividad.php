...
$tipo2 = ($actId > 0)?$actividad->tipo2:$tipo2;
...
foreach ($arrIds as $idItem) {
    ...
    $arrResponsable[] = array("valor"=>$idItem, "texto"=>$userItem->nombre);    
}
...
$arrCampoResponsable = array(
    array("nameid"=>"responsableId", "type"=>"select", "class"=>"form-control required likeDisaled".$claseResponsable, "readonly"=>false, "label"=>"Responsable:", "datos"=>$arrResponsable, "value"=>$responsableId),
);
...
$avanzo = ($actividad->idAccion > 0)?$actividad->avanzo:"";
...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10" style="<?php echo ($datosCaso->estatusId == 2)?'background-color: #fa0606':''; ?>">
                        ...
                        <h2>Num Expediente: <?php echo $datosCaso->numExpediente; ?></h2>
                            ...
                            <div class="panel panel-warning">
                                <div class="panel-heading"></div>
                                    ...
                                    <!-- <div class="row rowFechaCompromiso" style="display: <?php echo ($actId == 0)?'none':'block'; ?>;"> -->
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control <?php echo $claseCompromiso; ?> required" type="text" name="fechaCompromiso" id="fechaCompromiso" value="<?php echo ($actividad->fechaCompromiso != '')?convertirFechaVista($actividad->fechaCompromiso):"";?>" style="<?php echo $styleCompromiso; ?>"  readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control <?php echo $claseRealizado; ?>" type="text" name="fechaRealizado" id="fechaRealizado" value="<?php echo ($actividad->fechaRealizado!= '' )?convertirFechaVista($actividad->fechaRealizado):"";?>" style="<?php echo $stylRealizado; ?>" readonly>
                                        </div>
                                    </div>
                                    </div>
                            </div>
                            ...
                            <div class="panel panel-warning">
                                <div class="panel-heading"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control revisamaxlength required likeDisaled" name="pa_accion" id="pa_accion" value="<?php echo $actividad->nombre; ?>" maxlength="300">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 text-right">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control required likeDisaled" name="tipoactividad" id="tipoactividad">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 text-right">
                                        <label for="tipoactividad2">Tipo 2:</label>
                                        </div>
                                        <div class="col-md-8">
                                            <select class="form-control required likeDisaled" name="tipoactividad2" id="tipoactividad2" onchange="cambiaTipoActividad2(this.value)">
                                            <option value="">Seleccione...</option>
                                            <option value="1" <?php echo ($actividad->tipo == 1 || $tipo2 == 1)?"selected":""; ?>>Actividad</option>
                                            <option value="2" <?php echo ($actividad->tipo == 2 || $tipo2 == 2)?"selected":""; ?>>Reporte</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control required likeDisaled" name="importanciaactividad" id="importanciaactividad">
                                            <option value="">Seleccione...</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <select class="form-control required likeDisaled" name="estatusId" id="estatusId" onchange="cambiaEstatusActividad(this.value)">
                                            <option value="">Seleccione...</option>
                                ...
                                <div class="panel-heading">Descripci&oacute;n</div>
                                    <div class="panel-body"><br>
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <!-- <textarea class="form-control" name="pa_comentario" id="pa_comentario" rows="6" readonly=""> -->
                                                    <?php echo str_replace("&#34;",'"',$actividad->comentarios); ?>
                                                <!-- </textarea> -->
                    ...
                    <div class="row divInfoInterno" style="display: <?php echo ($actId == 0)?'block':'none'; ?>;">
                        <div class="col-xs-12 col-md-12">
                            <div class="panel panel-warning">
                                <div class="panel-heading">Comentarios internos:</div>
                                    ...
                                    <div class="row ">
                                        <div class="col-md-1"></div>
                                        <div class="col-md-10">
                                            <!-- <textarea class="form-control" name="pa_internos" id="pa_internos" rows="6" readonly=""> -->
                                                <?php echo str_replace("&#34;",'"',$actividad->internos); ?>
                                            <!-- </textarea> -->
                    ...
                    <div class="row rowReporte" style="display: none;">
                        <div class="col-xs-12 col-md-12">
                            <div class="panel panel-warning">
                                <div class="panel-heading">Reporte</div>
                                    <div class="panel-body"><br>
                                        <div class="row">
                                            <div class="col-md-1"></div>
                                            <div class="col-md-10">
                                                <!-- <textarea class="form-control" name="pa_reporte" id="pa_reporte" rows="6"> -->
                                                    <?php echo str_replace("&#34;",'"',$actividad->reporte); ?>
                                                <!-- </textarea> -->
    ...
    <script>
        $(document).ready(function(){
            var idActividad = $("#pa_idaccion").val();
