...
if(isset($_POST["idUsuario"])){
    ...
    $usuarioGObj->permisohistorico = $_POST["historico"];
    $usuarioGObj->numAbogado = $_POST["numabogado"];
    $usuarioGObj->coordinadorId = (isset($_POST["coordinadorId"]))?$_POST["coordinadorId"]:0;
...
$valorAbogado = ($usuarioObj->coordinadorId > 0)?$usuarioObj->coordinadorId:$valorAbogado;

$arrCampoAbogado = array(
    array("nameid"=>"coordinadorId", "type"=>"select", "class"=>"form-control selectpicker $claseAbogado", "readonly"=>true, "label"=>"Coordinador:", "datos"=>$arrAbogados, "value"=>$valorAbogado, "dataInput"=>$dataAbogados),
);
?>
    			...
    			<div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <form role="form" id="formUsuario" name="formUsuario" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="text-right form-group col-md-2 col-sm-2 col-xs-2">
                                    <label for="historico">Permiso Historico:</label>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <select class="form-control required" id="historico" name=" historico">
                                        <option value="1" <?php if($usuarioObj->activo == 1 || $usuarioObj->idUsuario === 0)echo "selected"; ?>>Si</option>
                                        <option value="0" <?php if($usuarioObj->activo == 0 && $usuarioObj->idUsuario > 0)echo "selected"; ?>>No</option>   
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                   <input class="form-control" type="text" name="numabogado" id="numabogado" value="<?php echo $usuarioObj->numAbogado ?>">
                                </div>
                            </div>

                            <?php
                            if($_SESSION["idUsuario"] == 1 || $_SESSION["idUsuario"] == 2){
                                $cols = array("label_xs"=>"2", "label_md"=>"2", "input_xs"=>"6", "input_md"=>"6");
