...
if($idRol == 1 || $idRol == 2){
    $result = $tareasObj->ObtTareasGrid("");
}
else{
    $result = $tareasObj->ObtTareasGrid("",0,$_SESSION['idUsuario']);
}
        ...
        <div class="panel-body">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <h1 class="titulo">Tareas <span class="pull-right"><a id="btnAyudaweb" onclick="mostrarAyuda('web_tareas')" href="#fancyAyudaWeb"><img src="../images/icon_ayuda.png" width="20px"></a></span></h1>  
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-offset-6 col-md-2 text-right">
                                ...
                                <a href="tarea.php"  title="Agregar tarea" class="btn btn-primary" target="_blank"><img width="16px" src="../images/iconos/iconos_grid/agregar.png"> Agregar</a>
                            </div>
                        </div>
                        <br/>
                        <div class="row">
