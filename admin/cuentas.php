...
include_once '../brules/cuentasObj.php';
//establecer la zona horaria
$dateByZone = new DateTime("now", new DateTimeZone('America/Mexico_City') );
$dateTime = $dateByZone->format('Y-m-d H:i:s'); //fecha Actual

$cuentasObj = new cuentasObj();
$result = $cuentasObj->ObtCuentasGrid();
        ...
        <div class="panel-body">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <h1 class="titulo">Cuentas por cobrar <span class="pull-right"><a id="btnAyudaweb" onclick="mostrarAyuda('web_inicio')" href="#fancyAyudaWeb"><img src="../images/icon_ayuda.png" width="20px"></a></span></h1>  
