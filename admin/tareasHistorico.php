...
if($idRol == 1 || $idRol == 2){
    $result = $tareasObj->ObtTareasGrid("",0,0,true);
}
else{
    $result = $tareasObj->ObtTareasGrid("",0,$_SESSION['idUsuario'],true);
}
...
<body>
    ...
    <input type="hidden" name="vista" id="vista" value="tareasHistorico">
        ...
        <div class="panel-body">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <h1 class="titulo">Tareas Histórico<span class="pull-right"><a id="btnAyudaweb" onclick="mostrarAyuda('web_inicio')" href="#fancyAyudaWeb"><img src="../images/icon_ayuda.png" width="20px"></a></span></h1>  


                        <ol class="breadcrumb">
                          <li><a href="index.php">Inicio</a></li>
                          <li><a href="tareas.php">Tareas</a></li>
                          <li class="active">Tareas Histórico</li>
                        </ol>

                        <div class="row">

                            <div class="col-md-2 text-right">
                                <a href="tareas.php" class="btn btn-primary">Regresar</a>
                            </div>  
