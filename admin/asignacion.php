...
$tareaId = (isset($_GET['asignacionId']))?$_GET['asignacionId']:0;
        ...
        <div class="panel-body">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <h1 class="titulo">Asignacion <span class="pull-right"><a id="btnAyudaweb" onclick="mostrarAyuda('web_asignacion')" href="#fancyAyudaWeb"><img src="../images/icon_ayuda.png" width="20px"></a></span></h1>  
                            ...
                            <div class="panel panel-warning">
                                <div class="panel-heading"></div>
                                    ...
                                    <!-- <div class="row rowFechaCompromiso" style="display: <?php echo ($tareaId == 0)?'none':'block'; ?>;"> -->
                                        ...
                                        <div class="col-md-8">
                                            <input class="form-control <?php echo $claseCompromiso; ?>" type="text" name="fechaCompromiso" id="fechaCompromiso" value="<?php echo ($tarea->fechaCompromiso != '')?convertirFechaVista($tarea->fechaCompromiso):"";?>" style="<?php echo $styleCompromiso; ?>"  readonly>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xs-12 col-md-6">
                            <div class="panel panel-warning">
                                <div class="panel-heading"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 text-right">
                                        <label for="pa_tarea">Asignaci&oacute;n:</label>
                                        </div>
                                        <div class="col-md-8">
                                    ...
                                    <div class="row oculto">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <option value="100">Asignacion</option>
                                    ...
                                    <div class="row oculto">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" name="importanciatarea" id="importanciatarea">
                                            <option value="0">Asignacion</option>
                                    ...
                                    <div class="row oculto">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <select class="form-control" name="estatusId" id="estatusId" onchange="cambiaEstatusActividad(this.value)">
                                            <option value="">Seleccione...</option>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                            <div class="panel panel-warning">
                                <div class="panel-heading">Descripci&oacute;n asignaci&oacute;n</div>
                                    <div class="panel-body"><br>
                                        <div class="row">
                    ...
                    <div class="row rowReporte oculto">
                        <div class="col-xs-12 col-md-12">
                            <div class="panel panel-warning">
